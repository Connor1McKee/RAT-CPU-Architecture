...
HD_PWD='C:/Users/conno/RAT2/RAT2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAT_WRAPPER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAT_WRAPPER.tcl

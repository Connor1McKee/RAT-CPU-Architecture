...
set_property PACKAGE_PIN T18 [get_ports MODE_BTN]						
	set_property IOSTANDARD LVCMOS33 [get_ports MODE_BTN]
set_property PACKAGE_PIN W19 [get_ports DBOS_BTN]						
	set_property IOSTANDARD LVCMOS33 [get_ports DBOS_BTN]
...
##Pmod Header JC
##Sch name = JC1
#set_property PACKAGE_PIN K17 [get_ports {PMOD[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PMOD[0]}]
###Sch name = JC2
#set_property PACKAGE_PIN M18 [get_ports {PMOD[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PMOD[1]}]
##Sch name = JC3
#set_property PACKAGE_PIN N17 [get_ports {PMOD[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PMOD[2]}]
##Sch name = JC4
#set_property PACKAGE_PIN P18 [get_ports {PMOD[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PMOD[3]}]
##Sch name = JC7
#set_property PACKAGE_PIN L17 [get_ports {PMOD[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PMOD[4]}]
##Sch name = JC8
#set_property PACKAGE_PIN M19 [get_ports {PMOD[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PMOD[5]}]
##Sch name = JC9
#set_property PACKAGE_PIN P17 [get_ports {PMOD[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PMOD[6]}]
##Sch name = JC10
#set_property PACKAGE_PIN R18 [get_ports {PMOD[7]}]					
